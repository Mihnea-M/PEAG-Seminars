...
# check the feasibility of the chosen x and compute the objective function f
#
...
def gen(fc,fv,max,dim):
    #read the data from the textfiles cost and value
    #
...
#2
#p=gi.gen("cost.txt","valoare.txt",30,10)